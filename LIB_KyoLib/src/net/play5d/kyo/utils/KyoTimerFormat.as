...
package net.play5d.kyo.utils
{
	...
	public class KyoTimerFormat
	{
		...
		public static function getTime(date:Date , sign:String = ' : ' , second:Boolean = true , type24:Boolean = true):String{
		...
		public static function getDateTime(date:Date , sign_date:String = '/' , sign_time:String = ' : ' , second:Boolean = true , type24:Boolean = true):String{
