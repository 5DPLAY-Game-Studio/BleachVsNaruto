...
public class DisplayEffect {
     ...
     */
    public static function ghostShadow(d:DisplayObject, alphaLose:Number = 0.1, startAlpha:Number = 1,
    ...
    private static function createInsShadow(d:DisplayObject, prams:Object = null, bpPrams:Object = null,
                                            size:Point                                           = null
    ):InsShadow {
