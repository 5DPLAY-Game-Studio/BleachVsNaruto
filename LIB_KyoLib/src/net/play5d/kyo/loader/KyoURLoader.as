...
package net.play5d.kyo.loader
{
	...
	public class KyoURLoader
	{
		...
		public static function getFileType(fileData:ByteArray):String {
			...
			if(b0 == 0xFF && b1 == 0xFE) return TYPE_UNICODE;
			if(b0 == 0xFE && b1 == 0xFF) return TYPE_UNICODE_BIG_ENDIAN;
			if(b0 == 0xEF && b1 == 0xBB) return TYPE_UTF8;
			return TYPE_ANSI;
		}
