...
package
{
	...
	import net.play5d.game.bvn.stage.TestLoadingState;
...
//			GameData.I.config.quality = GameQuailty.HIGH;
...
//
		...
		private function toogleBox(...params):void{
			...
			if(!_box.visible){
				...
				_box.x = (GameConfig.GAME_SIZE.x - 336) / 2;
				_box.y = (GameConfig.GAME_SIZE.y - 280) / 2;
		...
		private function boxMouseHandler(e:MouseEvent):void{
			if(e.type == MouseEvent.MOUSE_DOWN){
				(e.currentTarget as Sprite).startDrag(false);
			}else{
