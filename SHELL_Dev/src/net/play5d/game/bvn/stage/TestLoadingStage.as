...
public class TestLoadingStage implements IStage {
    ...
    public function build():void {
        ...
        for (var i:int; i < fighters.length; i++) {
            ...
            if (fighter) {
                if (fighter.bgm) {
                    fightBGMs.push({id: fighter.id, url: fighter.bgm, rate: fighter.bgmRate});
                }
            ...
            _loadQueue.push(
                    {
                        ...
                        params: [
                            o.id, function (fighter:FighterMain, runobj:Object):void {
            ...
            _loadQueue.push(
                    {
                        ...
                        params: [
                            o.id, function (fighter:Assister, runobj:Object):void {
        ...
        _loadQueue.push({
                            ...
                            params: [
                                GameData.I.selectMap, function (map:MapMain):void {
                                    if (map.data && map.data.bgm) {
                                        fightBGMs.push(
                                                {id: 'map', url: map.data.bgm, rate: 1});
                                    }
