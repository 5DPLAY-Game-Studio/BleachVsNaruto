			...
			if(params){
				if(params.x){
					if(params.x is Number){
						...
						if(params.x.start != undefined) speed.x = params.x.start;
						if(params.x.add != undefined) addSpeed.x = params.x.add * 2;
						if(params.x.max != undefined) maxSpeed.x = params.x.max;
						if(params.x.min != undefined) minSpeed.x = params.x.min;
				...
				if(params.y){
					if(params.y is Number){
						...
						if(params.y.start != undefined) speed.y = params.y.start;
						if(params.y.add != undefined) addSpeed.y = params.y.add * 2;
						if(params.y.max != undefined) maxSpeed.y = params.y.max;
						if(params.y.min != undefined) minSpeed.y = params.y.min;
