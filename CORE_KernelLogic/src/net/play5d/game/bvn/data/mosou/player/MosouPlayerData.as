...
package net.play5d.game.bvn.data.mosou.player
{
	...
	public class MosouPlayerData implements ISaveData
	{
		...
		public function readSaveObj(o:Object):void
		{
			...
			if(o.money) _money.setValue(o.money);

			if(o.lastLogin) _lastLogin.setValue(o.lastLogin);
			...
			if(o.currentMapId) _currentMapId = o.currentMapId;
			if(o.currentAreaId) _currentAreaId = o.currentAreaId;
